...
public final class ConfirmBooking_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	if(sMessage == null || sMessage.equals("")){
      ...
      out.write("\t\t\r\n");
      out.write("\t\t<br><br>\r\n");
      out.write("\t\t<p class=\"PageTitle\">Confirm Booking</p>\r\n");
 ...
 frTemp = alRecords.get(i);  
      ...
      out.write("</TD>\r\n");
      out.write("\t\t\t\t\t<td>");
      out.print(frTemp.getnNumSelectedSeats() );
      out.write("</td>\t\t\t\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t");
} 
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\tif (data.bSuccess){\r\n");
      out.write("\t\t\t\t\t\tUpdateBooking();\r\n");
      out.write("\t\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t\t$(\".ErrorMessage\").html(\"We were unable to post your transction to your bank for the following reason: <BR>\" +data.sMessage);\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t},\r\n");
      out.write("\t\t\t\terror: function(data){\r\n");
      out.write("\t\t\t\t\t$(\".ErrorMessage\").html(\"Internal error while communicating with the banking server, please try again later\");\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("  \t\t\t});\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t\r\n");
      ...
      out.write("        ({\r\n");
      out.write("            type: \"POST\",\r\n");
      out.write("            url: 'TransactionConfirmation',\r\n");
      out.write("            dataType: 'json',\r\n");
      out.write("            data:{ \t\r\n");
      out.write("\t\t\t\t\"bSubmit\":true\r\n");
      out.write("\t\t\t},\r\n");
      out.write("            success: function (data) {\r\n");
      out.write("\t\t\t\t$(\".ErrorMessage\").html(data.sMessage);\r\n");
      out.write("\t\t\t},\r\n");
      out.write("\t\t\terror: function(data){\r\n");
      out.write("\t\t\t\t$(\".ErrorMessage\").html(\"Internal Error retrieving your flight, please try again later.\");\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\r\n");
      out.write("\t}\r\n");
