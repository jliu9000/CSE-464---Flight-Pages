...
public final class ConfirmBooking_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	if(sMessage == null || sMessage.equals("")){
      ...
      out.write("<title>Confirm Transaction</title>\r\n");
      out.write("</head>\r\n");
      out.write("\r\n");
      out.write("\t");
		...
		try{
			dTotalCost = Double.parseDouble((String) request.getAttribute("dTotalCost"));
		} catch (Exception ex){
...
if(j == frTemp.getnNumSelectedSeats()){ 
      ...
      out.write("\t\t\t\t\t\t<input type=\"button\" value=\"Confirm\" onClick=\"ConfirmTransaction()\"></input>\r\n");
      out.write("\t\t\t\t        &nbsp;&nbsp;&nbsp;&nbsp;\r\n");
      ...
      out.write("\t\tif ((isNaN(dTotalCost) || dTotalCost < 0) || \r\n");
      out.write("\t\t\t\tisNaN(nAcctNumber) || isNaN(nRoutingNumber))){\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t} else {\r\n");
      out.write("\t\t\t$.ajax\r\n");
      out.write("            ({\r\n");
      out.write("                type: \"POST\",\r\n");
      out.write("                url: 'http://localhost:8080/Bank/PostTransaction',\r\n");
