...
<body>
		...
		<ul class="sidebar">
			...
			<li> </li>
			<li>Organization: <c:out value="${sessionScope.Clients.oOrg.sName}"/></li>
			<li> </li>
			<li> </li>
			<li><a href="<c:url value='./FlightSearch.jsp'/>">Home</a></li>
			<li><a href="<c:url value='./ShoppingCart.jsp'/>">Shopping Cart / Check Out</a></li>
			<li>
				<form action="<c:url value='BookingHistory'/>" method=post>	
